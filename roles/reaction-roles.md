...
{% hint style="info" %}
Temporary Reaction Roles are Patreon Only
{% endhint %}
...
| **rr temp &lt;msg\_id&gt; &lt;role&gt; &lt;time&gt;** | !rr temp 2389742349827 New Member 24h | This allows for roles to be temporarily be assigned to a member and then removed after the designated amount of time. |
