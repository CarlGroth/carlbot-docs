...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left">quickpoll
        <question | answers...>
      </td>
      ...
      style="text-align:left">Use pipes <code>|</code> or commas to separate the questions and answers.
        ...
        can't mix pipes and commas, pipes are intended for polls where you want
        commas in the question or answer.</td>
    </tr>
    <tr>
      <td style="text-align:left">[d|define]
        <word>
      </td>
      <td style="text-align:left">!define well</td>
      <td style="text-align:left">Shows the oxford dictionary's definition for the word. Note: due to the
        length of some definitions it might be a good idea to restrict this command
        to prevent abuse.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="text-align:left">[pick|choice|select]
        <choices>
      </td>
    ...
    <tr>
      <td style="text-align:left">[ud|urbandictionary]
        <word>
      </td>
    ...
    <tr>
      <td style="text-align:left">temp home
        <location>
      </td>
    ...
    <tr>
      <td style="text-align:left">[g|google]</td>
      <td style="text-align:left">!g umami wiki</td>
      <td style="text-align:left">Like googling, safesearch is set to medium.</td>
    </tr>
    <tr>
      <td style="text-align:left">avatar
        <member/ID>
      </td>
      <td style="text-align:left">!avatar</td>
      <td style="text-align:left">Shows the avatar of a mentioned user or yourself if you don't. Works even
        if the user doesn't share a server with the bot. Also works in dms, you
        creeps.</td>
    </tr>
    <tr>
